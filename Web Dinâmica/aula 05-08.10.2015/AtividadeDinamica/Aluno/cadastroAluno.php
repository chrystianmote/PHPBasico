                    ...
                    <div  class="col-md-8">
                        <div id="divForm" >
                            <form id="frmAluno"  name="frmAluno" action="ValidacaoAluno.php" method="post">
                                <table id="tableform">
                                    <tr>
                                        <td colspan="2"><h2><center> Cadastrar Aluno</center></h2></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control" name="txtDataNasc" id="txtDataNasc" type="text" placeholder="YYYY-mm-dd"></td>
                                    </tr>
                                    <tr>
                                        <td><label> Responsável: </label></td>
                                        <td><input  class="form-control" name="txtResp" id="txtResp" type="text"></td>
                                    </tr>

                                    <tr>
                                        <td><label> Status: </label></td>
                                        <td><select class="form-control" name="sltStatus" id="sltUF">
                    ...
                    <div class="col-md-8">
                        <div id="divForm" >
                            <form id="frmAlterarAluno" name="frmAlterarAluno" action="ValidacaoAluno.php" method="POST">
                                ...
                                ?>
                                <input type="hidden" name="update" id="update" value="<?php print_r($aluno[0]); ?>">

                                <table id="tableform" >
                                    <tr>
                                        <td colspan="2"><h2><center> Alterar Aluno</center></h2></td>
                                    </tr>
                                    <tr>
                                        <td><label>Código do Aluno: </label></td>
                                        <td><input value="<?php print_r($aluno[0]); ?>" name="txtCod" disabled="disabled" id="txtCod" type="text"></td>
                                    </tr>
                                    <tr>
                                        <td><label>Nome: </label></td>
                                        <td><input value="<?php print_r($aluno[1]); ?>" name="txtNome" id="txtNome" type="text"></td>
                                    </tr>
                                    <tr>
                                        <td><label>Endereço: </label></td>
                                        <td><input value="<?php print_r($aluno[2]); ?>"name="txtEnd" id="txtEnd" type="text"></td>
                                    </tr>
                                    <tr>
                                        <td><label>Cidade: </label></td>
                                        <td><input value="<?php print_r($aluno[3]); ?>" name="txtCid" id="txtCid" type="text"></td>
                                    </tr>
                                    <tr>
                                        <td><label>UF: </label></td>
                                        <td><select name="sltUF" id="sltUF">
                                                <option value="ES"<?php echo Onselected("ES", $aluno[4]); ?>>Espírito Santo</option>
                                                <option value="RJ"<?php echo Onselected("RJ", $aluno[4]); ?>>Rio de Janeiro</option>
                                                <option value="MG"<?php echo Onselected("MG", $aluno[4]); ?>>Minas Gerais</option>
                                                <option value="SP"<?php echo Onselected("SP", $aluno[4]); ?>>São Paulo</option>
                                            </select></td>
                                    </tr>
                                    <tr>
                                        <td><label>CEP: </label></td>
                                        <td><input value="<?php print_r($aluno[5]); ?>" name="txtCEP" id="txtCEP" type="text"></td>
                                    </tr>
                                    <tr>
                                        <td><label>Telefone: </label></td>
                                        <td><input value="<?php print_r($aluno[6]); ?>" name="txtTel" id="txtTel" type="text"></td>
                                    </tr>
                                    <tr>
                                        <td><label>Data de Nascimento: </label></td>
                                        <td><input value="<?php print_r($aluno[7]); ?>" name="txtDataNasc" id="txtDataNasc" type="text" placeholder="dd/MM/YYYY"></td>
                                    </tr>
                                    <tr>
                                        <td><label> Responsável: </label></td>
                                        <td><input value="<?php print_r($aluno[8]); ?>" name="txtResp" id="txtResp" type="text"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="sltStatus" id="sltStatus">
                                                <option value="Ativo"<?php echo Onselected("Ativo", $aluno[9]); ?>>Ativo</option>
                                                <option value="Inativo"<?php echo Onselected("Inativo", $aluno[9]); ?>>Inativo</option>
                                                <option value="Aprovado"<?php echo Onselected("Aprovado", $aluno[9]); ?>>Aprovado</option>
                                                <option value="Reprovado"<?php echo Onselected("Reprovado", $aluno[9]); ?>>Reprovado</option>
                                            </select></td>
                                    </tr>
